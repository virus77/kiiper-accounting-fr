...
class purchaseBook extends Component {
    ...
    onDownloadExcel = async () => {
        let resp = false;//await calls.getDocumentByTaxbookId(this.state.taxbookId, "/generatePurchasesBook");
            ...
            <div>
                <div className="container-fluid">
                    ...
                    <div className="row" style={{ paddingTop: "2%", paddingBottom: "15%" }}>
                        <Form>
                            <Form.Group>
                                <button name="name" id="xeroGenerate" onClick={this.onGetPeriod} >Generar</button>
                            </Form.Group>
                        </Form>
